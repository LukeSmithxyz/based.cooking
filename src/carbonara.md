...
3. Fry the preferred pork (Guanciale or Smoked Pancetta) in an iron or a nonstick pan (if using a different kind of pan add a dash of extra virgin olive oil) on low to medium heat until the sides are crisp and the inside is chewy.
